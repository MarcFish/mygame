...
player = MySprite()
player.load("./res/zombie_mob/farmer walk.png", 96, 96, 8)
player.position = 80, 80
player.direction = 4
player_group.add(player)

# create the zombie sprite
zombie_image = pygame.image.load("./res/zombie_mob/zombie walk.png").convert_alpha()
for n in range(0, 10):
    zombie = MySprite()
    zombie.load("./res/zombie_mob/zombie walk.png", 96, 96, 8)
...
# create heath sprite
health = MySprite()
health.load("./res/zombie_mob/health.png", 32, 32, 1)
