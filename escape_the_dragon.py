...
# load bitmaps
bg = pygame.image.load("./res/escape_the_dragon/background.png").convert_alpha()
...
dragon.load("./res/escape_the_dragon/dragon.png", 260, 150, 3)
dragon.position = 100, 230
group.add(dragon)

# create the player sprite
player = MySprite(screen)
player.load("./res/escape_the_dragon/caveman.png", 50, 64, 8)
...
arrow.load("./res/escape_the_dragon/flame.png", 40, 16, 1)
